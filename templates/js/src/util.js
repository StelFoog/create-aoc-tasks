...
export function taskFinder(task) {
...
export async function getInput(day, useExample = false) {
	if (useExample) {
...
export async function getTask(target) {
...
export function getTaskFile(task) {
	return path.join(TASK_FOLDER, `${task}.js`);
}

export const TASK_CONTENT = 'import { input } from "../src/inputManager.js";\n';
